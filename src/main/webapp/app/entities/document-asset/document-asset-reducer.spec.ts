...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTASSET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCUMENTASSET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCUMENTASSET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOCUMENTASSET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTASSET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCUMENTASSET actions', async () => {
      const arg = 42666;
